<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ActualizarEmenic.aspx.cs" Inherits="ProyectoASPEmenic.Paginas.Emenic.ActualizarEmenic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />        
    <div class="card border-primary mb-3">
        <div class="card-header"><h4>Representante Legal o Responsable de Empresa</h4></div>
        <div class="card-body text-primary">
            <div class="form-row">
                <div class="form-group col-md-6">
